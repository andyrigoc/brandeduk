    ...
    cards.forEach(card => {
        ...
        card.querySelectorAll('.price-badge').forEach(badge => {
            badge.addEventListener('click', (e) => {
                ...
                // If user clicks the currently selected method again, treat it as a reset.
                // This makes it easy to switch from Embroidery -> (reset) -> Print.
                if (badge.classList.contains('active') && positionMethods[position] === method) {
                    if (checkbox.checked) {
                        checkbox.checked = false;
                        checkbox.dispatchEvent(new Event('change'));
                    } else {
